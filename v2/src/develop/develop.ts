...
import { IKorevelRequest, KorevelHttpRunner } from "../modules/http/index.ts";
import { IKorevelLogger, KorevelLogger } from "../modules/logger/index.ts";
...
export class KorevelDevelopController {
  ...
  hello(request: IKorevelRequest) {
    console.log("request from hello", request)
    this.logger.log("Log Level", this.logger.getLogLevel());
