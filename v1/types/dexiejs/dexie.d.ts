...
export type ThenShortcut<T, TResult> = (
  value: T,
...
export interface PromiseExtended<T = any> extends Promise<T> {
  then<TResult1 = T, TResult2 = never>(
    ...
    onrejected?:
      ...
      | undefined
      | null,
  ): PromiseExtended<TResult1 | TResult2>;
  catch<TResult = never>(
    onrejected?:
...
export type KeyPathIgnoreObject =
  | ArrayBuffer
  | ArrayBufferView
  | RegExp
  | Blob
        ...
        : T[P] extends (...args: any[]) => any // Method
          ...
          : T[P] extends KeyPathIgnoreObject // Not valid in update spec or where clause (+ avoid circular reference)
            ...
            : T[P] extends object
              ?
                  | P
                  | `${P}.${KeyPaths<Required<T[P]>, MAXDEPTH, `${CURRDEPTH}I`>}`
              : P
    : never;
}[keyof T];
...
export type TableProp<DX> = {
  ...
  string;
export type TXWithTables<DX extends Dexie> = Dexie extends DX
...
export interface _Table<T, TKey, TInsertType> extends Table<
  T,
  TKey,
  TInsertType
> {}
...
export declare module Dexie {
  ...
  interface Table<T = any, Key = any, TInsertType = T> extends _Table<
    T,
    Key,
    TInsertType
...
export { Dexie as default, RangeSet$1 as RangeSet };
